...
export const cfg = {
  ...
  redModel: env.BEDROCK_MODEL_ID ?? "anthropic.claude-sonnet-4-20250514-v1:0",
  analystModel: env.BEDROCK_ANALYST_MODEL_ID ?? env.BEDROCK_MODEL_ID ?? "anthropic.claude-haiku-4-5-20251001-v1:0",
