...
export const cfg = {
  ...
  redModel: env.BEDROCK_MODEL_ID ?? "openai.gpt-oss-120b-1:0",
  analystModel: env.BEDROCK_ANALYST_MODEL_ID ?? env.BEDROCK_MODEL_ID ?? "amazon.nova-lite-v1:0",
  ...
  pollyVoiceEnMale: env.POLLY_VOICE_EN_MALE ?? "Matthew",
